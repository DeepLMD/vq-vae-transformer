...
def objective(trial):
    ...
    num_quantizers = trial.suggest_categorical('num_quantizers', [2, 4, 8])  # Number of quantizers in ResidualVQ
    groups = trial.suggest_categorical('groups', [2, 4, 8])
    ...
    parser.add_argument('--num_quantizers', type=int, default=num_quantizers, help='num_quantizers in grouped residual vector quantized')
    parser.add_argument('--groups', type=int, default=groups, help='groups in grouped residual vector quantized')
    ...
    if args.is_training:
        for ii in range(args.itr):
            ...
            setting = '{}_{}_{}_ft{}_sl{}_ll{}_pl{}_dm{}_nh{}_el{}_dl{}_df{}_lr{}_batch{}_FFN{}_vq{}_loss{}_revinlen{}_{}_GROUPED_RVQ_OPTUNA'.format(
                args.model_id,
                args.model,
                args.data,
                args.features,
