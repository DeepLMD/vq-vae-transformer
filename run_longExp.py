...
def objective(trial):
    ...
    num_quantizers =  trial.suggest_categorical('num_quantizers', [2, 4, 8])
    ...
    if args.is_training:
        for ii in range(args.itr):
            ...
            setting = '{}_{}_{}_ft{}_sl{}_ll{}_pl{}_dm{}_nh{}_el{}_dl{}_df{}_lr{}_batch{}_FFN{}_vq{}_loss{}_revinlen{}_{}_RESIDUAL_LFQ_OPTUNA'.format(
                args.model_id,
                args.model,
                args.data,
                args.features,
