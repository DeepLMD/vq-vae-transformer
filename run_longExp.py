...
def objective(trial):
    ...
    parser.add_argument('--codebook_size', type=int, default=trial.suggest_categorical('codebook_size', [500, 750, 1000]), help='codebook_size in sparse vector quantized')
...
if __name__ == '__main__':
    ...
    study.optimize(objective, n_trials=9)  # number of trials
