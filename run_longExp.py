...
def objective(trial):
    ...
    parser.add_argument('--num_quantizers', type=int, default=num_quantizers, help='num_quantizers in residual vector quantized')
    ...
    if args.is_training:
        for ii in range(args.itr):
            ...
            setting = '{}_{}_{}_ft{}_sl{}_ll{}_pl{}_dm{}_nh{}_el{}_dl{}_df{}_lr{}_batch{}_FFN{}_vq{}_loss{}_revinlen{}_{}_RVQ_OPTUNA'.format(
                args.model_id,
                args.model,
                args.data,
                args.features,
