...
def objective(trial):
    ...
    parser.add_argument('--codebook_size', type=int, default=trial.suggest_categorical('codebook_size', [256, 512, 1024, 2048]), help='codebook_size in sparse vector quantized')
