...
class SVQ_backbone(nn.Module):
    def __init__(self, codebook_size, length, svq, wFFN, c_in:int, context_window:int, target_window:int, patch_len:int, stride:int, num_quantizers:int, max_seq_len:Optional[int]=1024, 
        ...
        # Backbone 
        self.backbone = TSTiEncoder(codebook_size, svq, wFFN, c_in, patch_num=patch_num, patch_len=patch_len, num_quantizers=num_quantizers, max_seq_len=max_seq_len, 
...
class TSTiEncoder(nn.Module):  #i means channel-independent
    def __init__(self, codebook_size, svq, wFFN, c_in, patch_num, patch_len, num_quantizers, max_seq_len=1024,
...
class TSTEncoderLayer(nn.Module):
    def __init__(self, codebook_size, svq, wFFN, c_in, patch_num, patch_len, q_len, d_model, n_heads, num_quantizers, d_k=None, d_v=None, d_ff=256, store_attn=False,
        ...
        if self.svq:
            ...
            self.vq = ResidualVQ(dim=d_model, num_quantizers=num_quantizers, codebook_size=codebook_size, shared_codebook=True)
